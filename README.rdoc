...
database-backed web applications according to the {Model-View-Controller (MVC)}[link:http://en.wikipedia.org/wiki/Model%E2%80%93view%E2%80%93controller] pattern.
