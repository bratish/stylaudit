class PickCssSelectors
  ...
  def classes
    ...
    { 
      'clean_class_references'               => pure_class_references,
      'class_references_inside_script_tags' => dynamic_class_references,
      'partial_class_references'            => partial_class_references
    }
  end
end
